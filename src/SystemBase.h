...
//----------------------------------------------------------------------------------------------------
// Internal flash存储空间相关定义
//----------------------------------------------------------------------------------------------------
#define FLASH_CPU_APP_START_ADDR  0x08020000u
#define FILE_EXTRA_INFO_LENGTH    14u
#define FILE_INFO_LENGTH          0x80u
#define FLASH_CPU_APP_MIN_LENGTH  0x80u
#define FLASH_CPU_MAX_LENGTH      0x000A0000u
#define FLASH_CPU_APP_MAX_LENGTH  (FLASH_CPU_MAX_LENGTH - FILE_INFO_LENGTH - FILE_EXTRA_INFO_LENGTH)
#define FLASH_CPU_APP_END_ADDR    (FLASH_CPU_APP_START_ADDR + FLASH_CPU_MAX_LENGTH)
#define CPU_APP_FILE_INFO_ADDR    (FLASH_CPU_APP_END_ADDR -  FILE_INFO_LENGTH)
...
extern Uint16 DefaultCrcCal(Uint8 const *src, int32 length, Uint16 crc_base);
